...
class ShoppingList extends Component {
        ...
        if (holder.length > 0) {
          ...
          holder.forEach((element) => {
            ...
            if (store[0] === compare[0]) {
              ...
              var composition = storeValue + " " + store[0];
              array.push(composition)
            }
            i++;
          })
  ...
  handleDelete(key, e){
    ...
    for (var k in obj) {
      if (k !== "recipe") {
        ...
        var store = obj[k]
        if (holder.length > 0) {
          var array = this.state.ingredients[k]
          var i = 0
          store = store.split(' ')
          var storeValue = store.shift()
          holder.forEach((element) => {
  ...
  render() {
          ...
          addedRecipes.push(
            <div class="columns">
              <div class="column">
                ...
                <div class="column">
                  <button class="button is-danger" onClick={this.handleDelete.bind(this, key)}>Delete</button>
                </div>
            </div>
          )
        }
    ...
    return (
        <div>
          <p class="is-size-3">Shopping list</p>
            <div class="columns">
              <div class="column">
                  <div class="select">
              ...
              <div class="column">
                <button class="button is-primary" onClick={this.handleAdd}>Add</button>
              </div>
            </div>
              <div class="columns">
                  <div class="column box">
                    <p class="is-size-5">Added Recipes</p>
                    {addedRecipes}
                  </div>
                  <div class="column box">
                    <p class="is-size-5">ShoppingList</p>
                      {shoppingList}
                  </div>
                </div>
        </div>
